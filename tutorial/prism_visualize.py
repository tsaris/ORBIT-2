...
data_module = cl.data.IterDataModule(
    "downscaling",
    "/lustre/orion/world-shared/lrn036/jyc/frontier/ClimaX-v2/data/prism-superres/10.0_arcmin", 
    "/lustre/orion/world-shared/lrn036/jyc/frontier/ClimaX-v2/data/prism-superres/2.5_arcmin",
    in_vars,
    out_vars=[out_var_dict["prcp"]],
    subsample=1,
    batch_size=32,
    buffer_size=500,
    num_workers=1,
...
checkpoint_file = "/lustre/orion/nro108/scratch/xf9/checkpoints/climate/PRISM_rank_0_epoch_4.ckpt"
